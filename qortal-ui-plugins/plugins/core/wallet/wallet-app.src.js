...
const coinsNames = ['qort', 'btc', 'nmc', 'ltc', 'ppc', 'doge', 'dgb', 'dash', 'xvg', 'lbc', 'kmd', 'firo', 'zec', 'bch', 'rvn', 'vrsc']
...
class MultiWallet extends LitElement {
	...
	this.balance = 0
        ...
        this.ppcFeePerByte = 1000
        this.ppcSatMinFee = 1000
        this.ppcSatMaxFee = 1100
        ...
        this.xvgFeePerByte = 52000
        this.xvgSatMinFee = 52000
        this.xvgSatMaxFee = 52000
        this.lbcFeePerByte = 1 // fixme
        this.lbcSatMinFee = 1 // fixme
        this.lbcSatMaxFee = 1 // fixme
        ...
        this.bchFeePerByte = 1
        this.bchSatMinFee = 1
        this.bchSatMaxFee = 2
        this.rvnFeePerByte = 1125
        this.rvnSatMinFee = 1000
        this.rvnSatMaxFee = 10000
        this.vrscFeePerByte = 1 // fixme
        this.vrscSatMinFee = 1 // fixme
        this.vrscSatMaxFee = 1 // fixme
    ...
    render() {
        return html`
            <div class="wrapper">
                <div class="wallet">
                    ...
                    <div class="cards">
                        ...
                        <div coin="lbc" class="currency-box lbc">
                            <div class="currency-image"></div>
                            <div class="currency-text">LBRY</div>
                        </div>
                        ...
                        <div coin="zec" class="currency-box zec">
                            <div class="currency-image"></div>
                            <div class="currency-text">Zcash</div>
                        </div>
                        <div coin="bch" class="currency-box bch">
                            <div class="currency-image"></div>
                            <div class="currency-text">BitcoinCash</div>
                        </div>
                ...
                <mwc-dialog id="showPpcTransactionDetailsDialog" scrimClickAction="${this.showPpcTransactionDetailsLoading ? '' : 'close'}">
                    <div style="text-align: center;">
                        <h1>${translate("walletpage.wchange5")}</h1>
                        <hr />
                    </div>
                    <div id="transactionList">
                        ...
                        <div>
                            <span>${translate("walletpage.wchange40")}</span>
                            ${this.selectedTransaction.ppcTxnFlow === 'OUT' ? html`<span class="color-out">${translate("walletpage.wchange7")}</span>` : html`<span class="color-in">${translate("walletpage.wchange8")}</span>`}
                        </div>
                        <span class="title"> ${translate("walletpage.wchange9")} </span>
                        <br />
                        <div>
                            <span>${this.selectedTransaction.ppcSender}</span>
                        </div>
                         <span class="title"> ${translate("walletpage.wchange10")} </span>
                        <br />
                        <div>
                            <span>${this.selectedTransaction.ppcReceiver}</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange12")} </span>
                        <br />
                        <div>
                            <span>${(this.selectedTransaction.feeAmount / 1e8).toFixed(8)} PPC</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange37")} </span>
                        <br />
                        <div>
                            <span>${(this.selectedTransaction.totalAmount / 1e8).toFixed(8)} PPC</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange14")} </span>
                        <br />
                        <div><span>${new Date(this.selectedTransaction.timestamp).toString()}</span></div>
                ...
                <mwc-dialog id="showXvgTransactionDetailsDialog" scrimClickAction="${this.showXvgTransactionDetailsLoading ? '' : 'close'}">
                    <div style="text-align: center;">
                        <h1>${translate("walletpage.wchange5")}</h1>
                        <hr />
                    </div>
                    <div id="transactionList">
                        ...
                        <div>
                            ...
                            ${this.selectedTransaction.xvgTxnFlow === 'OUT' ? html`<span class="color-out">${translate("walletpage.wchange7")}</span>` : html`<span class="color-in">${translate("walletpage.wchange8")}</span>`}
                        </div>
                        <span class="title"> ${translate("walletpage.wchange9")} </span>
                        <br />
                        <div>

                            <span>${this.selectedTransaction.xvgSender}</span>
                        </div>
                         <span class="title"> ${translate("walletpage.wchange10")} </span>
                        <br />
                        <div>

                            <span>${this.selectedTransaction.xvgReceiver}</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange12")} </span>
                        <br />
                        <div>

                            <span>${(this.selectedTransaction.feeAmount / 1e8).toFixed(8)} XVG</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange37")} </span>
                        <br />
                        <div>

                            <span>${(this.selectedTransaction.totalAmount / 1e8).toFixed(8)} XVG</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange14")} </span>
                        <br />
                        <div><span>${new Date(this.selectedTransaction.timestamp).toString()}</span></div>
                ...
                <mwc-dialog id="showLbcTransactionDetailsDialog" scrimClickAction="${this.showLbcTransactionDetailsLoading ? '' : 'close'}">
                    <div style="text-align: center;">
                        <h1>${translate("walletpage.wchange5")}</h1>
                        <hr />
                    </div>
                    <div id="transactionList">
                        ...
                        <div>
                            <span>${translate("walletpage.wchange40")}</span>
                            ${this.selectedTransaction.lbcTxnFlow === 'OUT' ? html`<span class="color-out">${translate("walletpage.wchange7")}</span>` : html`<span class="color-in">${translate("walletpage.wchange8")}</span>`}
                        </div>
                        <span class="title"> ${translate("walletpage.wchange9")} </span>
                        <br />
                        <div>
                            <span>${this.selectedTransaction.lbcSender}</span>
                        </div>
                         <span class="title"> ${translate("walletpage.wchange10")} </span>
                        <br />
                        <div>
                            <span>${this.selectedTransaction.lbcReceiver}</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange12")} </span>
                        <br />
                        <div>
                            <span>${(this.selectedTransaction.feeAmount / 1e8).toFixed(8)} LBC</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange37")} </span>
                        <br />
                        <div>
                            <span>${(this.selectedTransaction.totalAmount / 1e8).toFixed(8)} LBC</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange14")} </span>
                        <br />
                        <div><span>${new Date(this.selectedTransaction.timestamp).toString()}</span></div>
                ...
                <mwc-dialog id="showKmdTransactionDetailsDialog" scrimClickAction="${this.showKmdTransactionDetailsLoading ? '' : 'close'}">
                    <div style="text-align: center;">
                        <h1>${translate("walletpage.wchange5")}</h1>
                        <hr />
                    </div>
                    <div id="transactionList">
                        ...
                        <div>
                            <span>${translate("walletpage.wchange40")}</span>
                            ${this.selectedTransaction.kmdTxnFlow === 'OUT' ? html`<span class="color-out">${translate("walletpage.wchange7")}</span>` : html`<span class="color-in">${translate("walletpage.wchange8")}</span>`}
                        </div>
                        <span class="title"> ${translate("walletpage.wchange9")} </span>
                        <br />
                        <div>
                            <span>${this.selectedTransaction.kmdSender}</span>
                        </div>
                         <span class="title"> ${translate("walletpage.wchange10")} </span>
                        <br />
                        <div>
                            <span>${this.selectedTransaction.kmdReceiver}</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange12")} </span>
                        <br />
                        <div>
                            <span>${(this.selectedTransaction.feeAmount / 1e8).toFixed(8)} KMD</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange37")} </span>
                        <br />
                        <div>
                ...
                <mwc-dialog id="showZecTransactionDetailsDialog" scrimClickAction="${this.showZecTransactionDetailsLoading ? '' : 'close'}">
                    <div style="text-align: center;">
                        <h1>${translate("walletpage.wchange5")}</h1>
                        <hr />
                    </div>
                    <div id="transactionList">
                        ...
                        <div>
                            <span>${translate("walletpage.wchange40")}</span>
                            ${this.selectedTransaction.zecTxnFlow === 'OUT' ? html`<span class="color-out">${translate("walletpage.wchange7")}</span>` : html`<span class="color-in">${translate("walletpage.wchange8")}</span>`}
                        </div>
                        <span class="title"> ${translate("walletpage.wchange9")} </span>
                        <br />
                        <div>
                            <span>${this.selectedTransaction.zecSender}</span>
                        </div>
                         <span class="title"> ${translate("walletpage.wchange10")} </span>
                        <br />
                        <div>
                            <span>${this.selectedTransaction.zecReceiver}</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange12")} </span>
                        <br />
                        <div>
                            <span>${(this.selectedTransaction.feeAmount / 1e8).toFixed(8)} ZEC</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange37")} </span>
                        <br />
                        <div>
                            <span>${(this.selectedTransaction.totalAmount / 1e8).toFixed(8)} ZEC</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange14")} </span>
                        <br />
                        <div><span>${new Date(this.selectedTransaction.timestamp).toString()}</span></div>
                ...
                <mwc-dialog id="showBchTransactionDetailsDialog" scrimClickAction="${this.showBchTransactionDetailsLoading ? '' : 'close'}">
                    <div style="text-align: center;">
                        <h1>${translate("walletpage.wchange5")}</h1>
                        <hr />
                    </div>
                    <div id="transactionList">
                        ...
                        <div>
                            <span>${translate("walletpage.wchange40")}</span>
                            ${this.selectedTransaction.bchTxnFlow === 'OUT' ? html`<span class="color-out">${translate("walletpage.wchange7")}</span>` : html`<span class="color-in">${translate("walletpage.wchange8")}</span>`}
                        </div>
                        <span class="title"> ${translate("walletpage.wchange9")} </span>
                        <br />
                        <div>
                            <span>${this.selectedTransaction.bchSender}</span>
                        </div>
                         <span class="title"> ${translate("walletpage.wchange10")} </span>
                        <br />
                        <div>
                            <span>${this.selectedTransaction.bchReceiver}</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange12")} </span>
                        <br />
                        <div>
                            <span>${(this.selectedTransaction.feeAmount / 1e8).toFixed(8)} BCH</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange37")} </span>
                        <br />
                        <div>
                            <span>${(this.selectedTransaction.totalAmount / 1e8).toFixed(8)} BCH</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange14")} </span>
                        <br />
                        <div><span>${new Date(this.selectedTransaction.timestamp).toString()}</span></div>
                ...
                <mwc-dialog id="showVrscTransactionDetailsDialog" scrimClickAction="${this.showVrscTransactionDetailsLoading ? '' : 'close'}">
                    <div style="text-align: center;">
                        <h1>${translate("walletpage.wchange5")}</h1>
                        <hr />
                    </div>
                    <div id="transactionList">
                        ...
                        <div>
                            <span>${translate("walletpage.wchange40")}</span>
                            ${this.selectedTransaction.vrscTxnFlow === 'OUT' ? html`<span class="color-out">${translate("walletpage.wchange7")}</span>` : html`<span class="color-in">${translate("walletpage.wchange8")}</span>`}
                        </div>
                        <span class="title"> ${translate("walletpage.wchange9")} </span>
                        <br />
                        <div>
                            <span>${this.selectedTransaction.vrscSender}</span>
                        </div>
                         <span class="title"> ${translate("walletpage.wchange10")} </span>
                        <br />
                        <div>
                            <span>${this.selectedTransaction.vrscReceiver}</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange12")} </span>
                        <br />
                        <div>
                            <span>${(this.selectedTransaction.feeAmount / 1e8).toFixed(8)} VRSC</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange37")} </span>
                        <br />
                        <div>
                            <span>${(this.selectedTransaction.totalAmount / 1e8).toFixed(8)} VRSC</span>
                        </div>
                        <span class="title"> ${translate("walletpage.wchange14")} </span>
                        <br />
                        <div><span>${new Date(this.selectedTransaction.timestamp).toString()}</span></div>
                ...
                <mwc-dialog id="sendPpcDialog">
                    <div class="send-coin-dialog">
                        <div style="text-align: center;">
                            <img src="/img/ppc.png" width="32" height="32">
                            <h2>${translate("walletpage.wchange17")} PPC</h2>
                            <hr />
                        </div>
                        <p>
                            <span>${translate("walletpage.wchange18")}:</span><br />
                        ...
                        <p>
                            <mwc-textfield
                                ...
                                @input="${(e) => { this._checkAmount(e) }}"
                                id="ppcAmountInput"
                                label="${translate("walletpage.wchange11")} (PPC)"
                                type="number"
                                auto-validate="false"
                                value="${this.ppcAmount}"
                            >
                            </mwc-textfield>
                        </p>
                        <p>
                            <mwc-textfield
                                ...
                                label="${translate("walletpage.wchange23")}"
                                type="text"
                                value="${this.ppcRecipient}"
                            >
                            </mwc-textfield>
                        </p>
                        <div style="margin-bottom: 0;">
                            <p style="margin-bottom: 0;">
                                ${translate("walletpage.wchange24")}: <span style="font-weight: bold;">${(this.ppcFeePerByte / 1e8).toFixed(8)} PPC</span><br>${translate("walletpage.wchange25")}
                            </p>
                            <paper-slider
                                class="blue"
                                style="width: 100%;"
                                pin
                                @change="${(e) => (this.ppcFeePerByte = e.target.value)}"
                                id="ppcFeeSlider"
                                min="${this.ppcSatMinFee}"
                                max="${this.ppcSatMaxFee}"
                                value="${this.ppcFeePerByte}"
                            >
                            </paper-slider>
                        </div>
                        <p style="color: red;">${this.errorMessage}</p>
                        ...
                        <div class="buttons">
                            <div>
                                <vaadin-button ?disabled="${this.btnDisable}" theme="primary medium" style="width: 100%;" @click=${() => this.sendPpc()}>
                                    <vaadin-icon icon="vaadin:arrow-forward" slot="prefix"></vaadin-icon>
                                    ${translate("walletpage.wchange17")} PPC
                                </vaadin-button>
                            </div>
                        </div>
                    </div>
                ...
                <mwc-dialog id="sendXvgDialog">
                    <div class="send-coin-dialog">
                        <div style="text-align: center;">
                            <img src="/img/xvg.png" width="32" height="32">
                            <h2>${translate("walletpage.wchange17")} XVG</h2>
                            <hr />
                        </div>
                        <p>
                            <span>${translate("walletpage.wchange18")}:</span><br />
                        ...
                        <p>
                            <mwc-textfield
                                ...
                                @input="${(e) => { this._checkAmount(e) }}"
                                id="xvgAmountInput"
                                label="${translate("walletpage.wchange11")} (XVG)"
                                type="number"
                                auto-validate="false"
                                value="${this.xvgAmount}"
                            >
                            </mwc-textfield>
                        </p>
                        <p>
                            <mwc-textfield
                                ...
                                label="${translate("walletpage.wchange23")}"
                                type="text"
                                value="${this.xvgRecipient}"
                            >
                            </mwc-textfield>
                        </p>
                        <div style="margin-bottom: 0;">
                            <p style="margin-bottom: 0;">
                                ${translate("walletpage.wchange24")}: <span style="font-weight: bold;">${(this.xvgFeePerByte / 1e8).toFixed(8)} XVG</span><br>${translate("walletpage.wchange25")}
                            </p>
                            <paper-slider
                                class="blue"
                                style="width: 100%;"
                                pin
                                @change="${(e) => (this.xvgFeePerByte = e.target.value)}"
                                id="xvgFeeSlider"
                                min="${this.xvgSatMinFee}"
                                max="${this.xvgSatMaxFee}"
                                value="${this.xvgFeePerByte}"
                            >
                            </paper-slider>
                        </div>
                        <p style="color: red;">${this.errorMessage}</p>
                        ...
                        <div class="buttons">
                            <div>
                                <vaadin-button ?disabled="${this.btnDisable}" theme="primary medium" style="width: 100%;" @click=${() => this.sendXvg()}>
                                    <vaadin-icon icon="vaadin:arrow-forward" slot="prefix"></vaadin-icon>
                                    ${translate("walletpage.wchange17")} XVG
                                </vaadin-button>
                            </div>
                        </div>
                    </div>
                ...
                <mwc-dialog id="sendLbcDialog">
                    <div class="send-coin-dialog">
                        <div style="text-align: center;">
                            <img src="/img/lbc.png" width="32" height="32">
                            <h2>${translate("walletpage.wchange17")} LBC</h2>
                            <hr />
                        </div>
                        <p>
                            <span>${translate("walletpage.wchange18")}:</span><br />
                        ...
                        <p>
                            <mwc-textfield
                                ...
                                @input="${(e) => { this._checkAmount(e) }}"
                                id="lbcAmountInput"
                                label="${translate("walletpage.wchange11")} (LBC)"
                                type="number"
                                auto-validate="false"
                                value="${this.lbcAmount}"
                            >
                            </mwc-textfield>
                        </p>
                        <p>
                            <mwc-textfield
                                ...
                                label="${translate("walletpage.wchange23")}"
                                type="text"
                                value="${this.lbcRecipient}"
                            >
                            </mwc-textfield>
                        </p>
                        <div style="margin-bottom: 0;">
                            <p style="margin-bottom: 0;">
                                ${translate("walletpage.wchange24")}: <span style="font-weight: bold;">${(this.lbcFeePerByte / 1e8).toFixed(8)} LBC</span><br>${translate("walletpage.wchange25")}
                            </p>
                            <paper-slider
                                class="blue"
                                style="width: 100%;"
                                pin
                                @change="${(e) => (this.lbcFeePerByte = e.target.value)}"
                                id="lbcFeeSlider"
                                min="${this.lbcSatMinFee}"
                                max="${this.lbcSatMaxFee}"
                                value="${this.lbcFeePerByte}"
                            >
                            </paper-slider>
                        </div>
                        <p style="color: red;">${this.errorMessage}</p>
                        ...
                        <div class="buttons">
                            <div>
                                <vaadin-button ?disabled="${this.btnDisable}" theme="primary medium" style="width: 100%;" @click=${() => this.sendLbc()}>
                                    <vaadin-icon icon="vaadin:arrow-forward" slot="prefix"></vaadin-icon>
                                    ${translate("walletpage.wchange17")} LBC
                                </vaadin-button>
                            </div>
                        </div>
                    </div>
                ...
                <mwc-dialog id="sendKmdDialog">
                    <div class="send-coin-dialog">
                        <div style="text-align: center;">
                            <img src="/img/kmd.png" width="32" height="32">
                            <h2>${translate("walletpage.wchange17")} KMD</h2>
                            <hr />
                        </div>
                        <p>
                            <span>${translate("walletpage.wchange18")}:</span><br />
                        ...
                        <p>
                            <mwc-textfield
                                ...
                                @input="${(e) => { this._checkAmount(e) }}"
                                id="kmdAmountInput"
                                label="${translate("walletpage.wchange11")} (KMD)"
                                type="number"
                                auto-validate="false"
                                value="${this.kmdAmount}"
                            >
                            </mwc-textfield>
                        </p>
                        <p>
                            <mwc-textfield
                                ...
                                label="${translate("walletpage.wchange23")}"
                                type="text"
                                value="${this.kmdRecipient}"
                            >
                            </mwc-textfield>
                        </p>
                        <div style="margin-bottom: 0;">
                            <p style="margin-bottom: 0;">
                                ${translate("walletpage.wchange24")}: <span style="font-weight: bold;">${(this.kmdFeePerByte / 1e8).toFixed(8)} KMD</span><br>${translate("walletpage.wchange25")}
                            </p>
                            <paper-slider
                                class="blue"
                                style="width: 100%;"
                                pin
                                @change="${(e) => (this.kmdFeePerByte = e.target.value)}"
                                id="kmdFeeSlider"
                                min="${this.kmdSatMinFee}"
                                max="${this.kmdSatMaxFee}"
                                value="${this.kmdFeePerByte}"
                            >
                            </paper-slider>
                        </div>
                        <p style="color: red;">${this.errorMessage}</p>
                        ...
                        <div class="buttons">
                            <div>
                                <vaadin-button ?disabled="${this.btnDisable}" theme="primary medium" style="width: 100%;" @click=${() => this.sendKmd()}>
                                    <vaadin-icon icon="vaadin:arrow-forward" slot="prefix"></vaadin-icon>
                                    ${translate("walletpage.wchange17")} KMD
                                </vaadin-button>
                            </div>
                        </div>
                    </div>
                ...
                <mwc-dialog id="sendZecDialog">
                    <div class="send-coin-dialog">
                        <div style="text-align: center;">
                            <img src="/img/zec.png" width="32" height="32">
                            <h2>${translate("walletpage.wchange17")} ZEC</h2>
                            <hr />
                        </div>
                        <p>
                            <span>${translate("walletpage.wchange18")}:</span><br />
                        ...
                        <p>
                            <mwc-textfield
                                ...
                                @input="${(e) => { this._checkAmount(e) }}"
                                id="zecAmountInput"
                                label="${translate("walletpage.wchange11")} (ZEC)"
                                type="number"
                                auto-validate="false"
                                value="${this.zecAmount}"
                            >
                            </mwc-textfield>
                        </p>
                        <p>
                            <mwc-textfield
                                ...
                                label="${translate("walletpage.wchange23")}"
                                type="text"
                                value="${this.zecRecipient}"
                            >
                            </mwc-textfield>
                        </p>
                        <div style="margin-bottom: 0;">
                            <p style="margin-bottom: 0;">
                                ${translate("walletpage.wchange24")}: <span style="font-weight: bold;">${(this.zecFeePerByte / 1e8).toFixed(8)} ZEC</span><br>${translate("walletpage.wchange25")}
                            </p>
                            <paper-slider
                                class="blue"
                                style="width: 100%;"
                                pin
                                @change="${(e) => (this.zecFeePerByte = e.target.value)}"
                                id="zecFeeSlider"
                                min="${this.zecSatMinFee}"
                                max="${this.zecSatMaxFee}"
                                value="${this.zecFeePerByte}"
                            >
                            </paper-slider>
                        </div>
                        <p style="color: red;">${this.errorMessage}</p>
                        ...
                        <div class="buttons">
                            <div>
                                <vaadin-button ?disabled="${this.btnDisable}" theme="primary medium" style="width: 100%;" @click=${() => this.sendZec()}>
                                    <vaadin-icon icon="vaadin:arrow-forward" slot="prefix"></vaadin-icon>
                                    ${translate("walletpage.wchange17")} ZEC
                                </vaadin-button>
                            </div>
                        </div>
                    </div>
                ...
                <mwc-dialog id="sendBchDialog">
                    <div class="send-coin-dialog">
                        <div style="text-align: center;">
                            <img src="/img/bch.png" width="32" height="32">
                            <h2>${translate("walletpage.wchange17")} BCH</h2>
                            <hr />
                        </div>
                        <p>
                            <span>${translate("walletpage.wchange18")}:</span><br />
                        ...
                        <p>
                            <mwc-textfield
                                ...
                                @input="${(e) => { this._checkAmount(e) }}"
                                id="bchAmountInput"
                                label="${translate("walletpage.wchange11")} (BCH)"
                                type="number"
                                auto-validate="false"
                                value="${this.bchAmount}"
                            >
                            </mwc-textfield>
                        </p>
                        <p>
                            <mwc-textfield
                                ...
                                label="${translate("walletpage.wchange23")}"
                                type="text"
                                value="${this.bchRecipient}"
                            >
                            </mwc-textfield>
                        </p>
                        <div style="margin-bottom: 0;">
                            <p style="margin-bottom: 0;">
                                ${translate("walletpage.wchange24")}: <span style="font-weight: bold;">${(this.bchFeePerByte / 1e8).toFixed(8)} BCH</span><br>${translate("walletpage.wchange25")}
                            </p>
                            <paper-slider
                                class="blue"
                                style="width: 100%;"
                                pin
                                @change="${(e) => (this.bchFeePerByte = e.target.value)}"
                                id="bchFeeSlider"
                                min="${this.bchSatMinFee}"
                                max="${this.bchSatMaxFee}"
                                value="${this.bchFeePerByte}"
                            >
                            </paper-slider>
                        </div>
                        <p style="color: red;">${this.errorMessage}</p>
                        ...
                        <div class="buttons">
                            <div>
                                <vaadin-button ?disabled="${this.btnDisable}" theme="primary medium" style="width: 100%;" @click=${() => this.sendBch()}>
                                    <vaadin-icon icon="vaadin:arrow-forward" slot="prefix"></vaadin-icon>
                                    ${translate("walletpage.wchange17")} BCH
                                </vaadin-button>
                            </div>
                        </div>
                    </div>
                ...
                <mwc-dialog id="sendVrscDialog">
                    <div class="send-coin-dialog">
                        <div style="text-align: center;">
                            <img src="/img/vrsc.png" width="32" height="32">
                            <h2>${translate("walletpage.wchange17")} VRSC</h2>
                            <hr />
                        </div>
                        <p>
                            <span>${translate("walletpage.wchange18")}:</span><br />
                        ...
                        <p>
                            <mwc-textfield
                                ...
                                @input="${(e) => { this._checkAmount(e) }}"
                                id="vrscAmountInput"
                                label="${translate("walletpage.wchange11")} (VRSC)"
                                type="number"
                                auto-validate="false"
                                value="${this.vrscAmount}"
                            >
                            </mwc-textfield>
                        </p>
                        <p>
                            <mwc-textfield
                                ...
                                label="${translate("walletpage.wchange23")}"
                                type="text"
                                value="${this.vrscRecipient}"
                            >
                            </mwc-textfield>
                        </p>
                        <div style="margin-bottom: 0;">
                            <p style="margin-bottom: 0;">
                                ${translate("walletpage.wchange24")}: <span style="font-weight: bold;">${(this.vrscFeePerByte / 1e8).toFixed(8)} VRSC</span><br>${translate("walletpage.wchange25")}
                            </p>
                            <paper-slider
                                class="blue"
                                style="width: 100%;"
                                pin
                                @change="${(e) => (this.vrscFeePerByte = e.target.value)}"
                                id="vrscFeeSlider"
                                min="${this.vrscSatMinFee}"
                                max="${this.vrscSatMaxFee}"
                                value="${this.vrscFeePerByte}"
                            >
                            </paper-slider>
                        </div>
                        <p style="color: red;">${this.errorMessage}</p>
                        ...
                        <div class="buttons">
                            <div>
                                <vaadin-button ?disabled="${this.btnDisable}" theme="primary medium" style="width: 100%;" @click=${() => this.sendVrsc()}>
                                    <vaadin-icon icon="vaadin:arrow-forward" slot="prefix"></vaadin-icon>
                                    ${translate("walletpage.wchange17")} VRSC
                                </vaadin-button>
                            </div>
                        </div>
                    </div>
	...
	setInterval(() => {
        ...
        this.shadowRoot.getElementById('ppcAmountInput').addEventListener('contextmenu', (event) => {
            const getSelectedText = () => {
                var text = ''
                if (typeof window.getSelection != 'undefined') {
                    text = window.getSelection().toString()
            ...
            const checkSelectedTextAndShowMenu = () => {
                ...
                if (selectedText && typeof selectedText === 'string') {
                    ...
                    this.pasteMenu(event, 'ppcAmountInput')
                    this.isPasteMenuOpen = true
                    event.preventDefault()
                    event.stopPropagation()
                }
        ...
        this.shadowRoot.getElementById('ppcRecipient').addEventListener('contextmenu', (event) => {
            const getSelectedText = () => {
                var text = ''
                if (typeof window.getSelection != 'undefined') {
                    text = window.getSelection().toString()
            ...
            const checkSelectedTextAndShowMenu = () => {
                ...
                if (selectedText && typeof selectedText === 'string') {
                    ...
                    this.pasteMenu(event, 'ppcRecipient')
                    this.isPasteMenuOpen = true
                    event.preventDefault()
                    event.stopPropagation()
                }
        ...
        this.shadowRoot.getElementById('xvgAmountInput').addEventListener('contextmenu', (event) => {
            const getSelectedText = () => {
                var text = ''
                if (typeof window.getSelection != 'undefined') {
                    text = window.getSelection().toString()
            ...
            const checkSelectedTextAndShowMenu = () => {
                ...
                if (selectedText && typeof selectedText === 'string') {
                    ...
                    this.pasteMenu(event, 'xvgAmountInput')
                    this.isPasteMenuOpen = true
                    event.preventDefault()
                    event.stopPropagation()
                }
        ...
        this.shadowRoot.getElementById('xvgRecipient').addEventListener('contextmenu', (event) => {
            const getSelectedText = () => {
                var text = ''
                if (typeof window.getSelection != 'undefined') {
                    text = window.getSelection().toString()
            ...
            const checkSelectedTextAndShowMenu = () => {
                ...
                if (selectedText && typeof selectedText === 'string') {
                    ...
                    this.pasteMenu(event, 'xvgRecipient')
                    this.isPasteMenuOpen = true
                    event.preventDefault()
                    event.stopPropagation()
                }
        ...
        this.shadowRoot.getElementById('lbcAmountInput').addEventListener('contextmenu', (event) => {
            const getSelectedText = () => {
                var text = ''
                if (typeof window.getSelection != 'undefined') {
                    text = window.getSelection().toString()
            ...
            const checkSelectedTextAndShowMenu = () => {
                ...
                if (selectedText && typeof selectedText === 'string') {
                    ...
                    this.pasteMenu(event, 'lbcAmountInput')
                    this.isPasteMenuOpen = true
                    event.preventDefault()
                    event.stopPropagation()
                }
        ...
        this.shadowRoot.getElementById('lbcRecipient').addEventListener('contextmenu', (event) => {
            const getSelectedText = () => {
                var text = ''
                if (typeof window.getSelection != 'undefined') {
                    text = window.getSelection().toString()
            ...
            const checkSelectedTextAndShowMenu = () => {
                ...
                if (selectedText && typeof selectedText === 'string') {
                    ...
                    this.pasteMenu(event, 'lbcRecipient')
                    this.isPasteMenuOpen = true
                    event.preventDefault()
                    event.stopPropagation()
                }
        ...
        this.shadowRoot.getElementById('kmdAmountInput').addEventListener('contextmenu', (event) => {
            const getSelectedText = () => {
                var text = ''
                if (typeof window.getSelection != 'undefined') {
                    text = window.getSelection().toString()
            ...
            const checkSelectedTextAndShowMenu = () => {
                ...
                if (selectedText && typeof selectedText === 'string') {
                    ...
                    this.pasteMenu(event, 'kmdAmountInput')
                    this.isPasteMenuOpen = true
                    event.preventDefault()
                    event.stopPropagation()
                }
        ...
        this.shadowRoot.getElementById('kmdRecipient').addEventListener('contextmenu', (event) => {
            const getSelectedText = () => {
                var text = ''
                if (typeof window.getSelection != 'undefined') {
                    text = window.getSelection().toString()
        ...
        this.shadowRoot.getElementById('zecAmountInput').addEventListener('contextmenu', (event) => {
            const getSelectedText = () => {
                var text = ''
                if (typeof window.getSelection != 'undefined') {
                    text = window.getSelection().toString()
            ...
            const checkSelectedTextAndShowMenu = () => {
                ...
                if (selectedText && typeof selectedText === 'string') {
                    ...
                    this.pasteMenu(event, 'zecAmountInput')
                    this.isPasteMenuOpen = true
                    event.preventDefault()
                    event.stopPropagation()
                }
        ...
        this.shadowRoot.getElementById('zecRecipient').addEventListener('contextmenu', (event) => {
            const getSelectedText = () => {
                var text = ''
                if (typeof window.getSelection != 'undefined') {
                    text = window.getSelection().toString()
            ...
            const checkSelectedTextAndShowMenu = () => {
                ...
                if (selectedText && typeof selectedText === 'string') {
                    ...
                    this.pasteMenu(event, 'zecRecipient')
                    this.isPasteMenuOpen = true
                    event.preventDefault()
                    event.stopPropagation()
                }
        ...
        this.shadowRoot.getElementById('bchAmountInput').addEventListener('contextmenu', (event) => {
            const getSelectedText = () => {
                var text = ''
                if (typeof window.getSelection != 'undefined') {
                    text = window.getSelection().toString()
            ...
            const checkSelectedTextAndShowMenu = () => {
                ...
                if (selectedText && typeof selectedText === 'string') {
                    ...
                    this.pasteMenu(event, 'bchAmountInput')
                    this.isPasteMenuOpen = true
                    event.preventDefault()
                    event.stopPropagation()
                }
        ...
        this.shadowRoot.getElementById('bchRecipient').addEventListener('contextmenu', (event) => {
            const getSelectedText = () => {
                var text = ''
                if (typeof window.getSelection != 'undefined') {
                    text = window.getSelection().toString()
            ...
            const checkSelectedTextAndShowMenu = () => {
                ...
                if (selectedText && typeof selectedText === 'string') {
                    ...
                    this.pasteMenu(event, 'bchRecipient')
                    this.isPasteMenuOpen = true
                    event.preventDefault()
                    event.stopPropagation()
                }
        ...
        this.shadowRoot.getElementById('vrscAmountInput').addEventListener('contextmenu', (event) => {
            const getSelectedText = () => {
                var text = ''
                if (typeof window.getSelection != 'undefined') {
                    text = window.getSelection().toString()
            ...
            const checkSelectedTextAndShowMenu = () => {
                ...
                if (selectedText && typeof selectedText === 'string') {
                    ...
                    this.pasteMenu(event, 'vrscAmountInput')
                    this.isPasteMenuOpen = true
                    event.preventDefault()
                    event.stopPropagation()
                }
        ...
        this.shadowRoot.getElementById('vrscRecipient').addEventListener('contextmenu', (event) => {
            const getSelectedText = () => {
                var text = ''
                if (typeof window.getSelection != 'undefined') {
                    text = window.getSelection().toString()
            ...
            const checkSelectedTextAndShowMenu = () => {
                ...
                if (selectedText && typeof selectedText === 'string') {
                    ...
                    this.pasteMenu(event, 'vrscRecipient')
                    this.isPasteMenuOpen = true
                    event.preventDefault()
                    event.stopPropagation()
                }
    ...
    async sendPpc() {
        const ppcAmount = this.shadowRoot.getElementById('ppcAmountInput').value
        let ppcRecipient = this.shadowRoot.getElementById('ppcRecipient').value
        const xprv58 = this.wallets.get(this._selectedWallet).wallet.derivedMasterPrivateKey
        ...
        const makeRequest = async () => {
            const opts = {
                xprv58: xprv58,
                receivingAddress: ppcRecipient,
                peercoinAmount: ppcAmount,
                feePerByte: (this.ppcFeePerByte / 1e8).toFixed(8),
            }
            const response = await parentEpml.request('sendPpc', opts)
            return response
        }

        const manageResponse = (response) => {
            if (response.length === 64) {
                this.shadowRoot.getElementById('ppcAmountInput').value = 0
                this.shadowRoot.getElementById('ppcRecipient').value = ''
                this.errorMessage = ''
                this.ppcRecipient = ''
                this.ppcAmount = 0
                this.successMessage = this.renderSuccessText()
    ...
    async sendXvg() {
        const xvgAmount = this.shadowRoot.getElementById('xvgAmountInput').value
        let xvgRecipient = this.shadowRoot.getElementById('xvgRecipient').value
        const xprv58 = this.wallets.get(this._selectedWallet).wallet.derivedMasterPrivateKey
        ...
        const manageResponse = (response) => {
            if (response.length === 64) {
                this.shadowRoot.getElementById('xvgAmountInput').value = 0
                this.shadowRoot.getElementById('xvgRecipient').value = ''
                this.errorMessage = ''
                this.xvgRecipient = ''
                this.xvgAmount = 0
                this.successMessage = this.renderSuccessText()
    ...
    async sendLbc() {
        const lbcAmount = this.shadowRoot.getElementById('lbcAmountInput').value
        let lbcRecipient = this.shadowRoot.getElementById('lbcRecipient').value
        const xprv58 = this.wallets.get(this._selectedWallet).wallet.derivedMasterPrivateKey
        ...
        const makeRequest = async () => {
            const opts = {
                xprv58: xprv58,
                receivingAddress: lbcRecipient,
                lbryAmount: lbcAmount,
                feePerByte: (this.lbcFeePerByte / 1e8).toFixed(8),
            }
            const response = await parentEpml.request('sendLbc', opts)
            return response
        }

        const manageResponse = (response) => {
            if (response.length === 64) {
                this.shadowRoot.getElementById('lbcAmountInput').value = 0
                this.shadowRoot.getElementById('lbcRecipient').value = ''
                this.errorMessage = ''
                this.lbcRecipient = ''
                this.lbcAmount = 0
                this.successMessage = this.renderSuccessText()
    ...
    async sendKmd() {
        const kmdAmount = this.shadowRoot.getElementById('kmdAmountInput').value
        let kmdRecipient = this.shadowRoot.getElementById('kmdRecipient').value
        const xprv58 = this.wallets.get(this._selectedWallet).wallet.derivedMasterPrivateKey
        ...
        const makeRequest = async () => {
            const opts = {
                xprv58: xprv58,
                receivingAddress: kmdRecipient,
                komodoAmount: kmdAmount,
                feePerByte: (this.kmdFeePerByte / 1e8).toFixed(8),
            }
            const response = await parentEpml.request('sendKmd', opts)
            return response
        }

        const manageResponse = (response) => {
            if (response.length === 64) {
                this.shadowRoot.getElementById('kmdAmountInput').value = 0
                this.shadowRoot.getElementById('kmdRecipient').value = ''
                this.errorMessage = ''
                this.kmdRecipient = ''
                this.kmdAmount = 0
                this.successMessage = this.renderSuccessText()
    ...
    async sendZec() {
        ...
        const makeRequest = async () => {
            const opts = {
                xprv58: xprv58,
                receivingAddress: zecRecipient,
                zcashAmount: zecAmount,
                feePerByte: (this.zecFeePerByte / 1e8).toFixed(8),
            }
            const response = await parentEpml.request('sendZec', opts)
            return response
        }

        const manageResponse = (response) => {
            if (response.length === 64) {
                this.shadowRoot.getElementById('zecAmountInput').value = 0
                this.shadowRoot.getElementById('zecRecipient').value = ''
                this.errorMessage = ''
                this.zecRecipient = ''
                this.zecAmount = 0
                this.successMessage = this.renderSuccessText()
    ...
    async sendBch() {
        const bchAmount = this.shadowRoot.getElementById('bchAmountInput').value
        let bchRecipient = this.shadowRoot.getElementById('bchRecipient').value
        const xprv58 = this.wallets.get(this._selectedWallet).wallet.derivedMasterPrivateKey
        ...
        const makeRequest = async () => {
            const opts = {
                xprv58: xprv58,
                receivingAddress: bchRecipient,
                bitcoinCashAmount: bchAmount,
                feePerByte: (this.bchFeePerByte / 1e8).toFixed(8),
            }
            const response = await parentEpml.request('sendBch', opts)
            return response
        }

        const manageResponse = (response) => {
            if (response.length === 64) {
                this.shadowRoot.getElementById('bchAmountInput').value = 0
                this.shadowRoot.getElementById('bchRecipient').value = ''
                this.errorMessage = ''
                this.bchRecipient = ''
                this.bchAmount = 0
                this.successMessage = this.renderSuccessText()
    ...
    async sendVrsc() {
        const vrscAmount = this.shadowRoot.getElementById('vrscAmountInput').value
        let vrscRecipient = this.shadowRoot.getElementById('vrscRecipient').value
        const xprv58 = this.wallets.get(this._selectedWallet).wallet.derivedMasterPrivateKey
        ...
        const makeRequest = async () => {
            const opts = {
                xprv58: xprv58,
                receivingAddress: vrscRecipient,
                verusCoinAmount: vrscAmount,
                feePerByte: (this.vrscFeePerByte / 1e8).toFixed(8),
            }
            const response = await parentEpml.request('sendVrsc', opts)
            return response
        }

        const manageResponse = (response) => {
            if (response.length === 64) {
                this.shadowRoot.getElementById('vrscAmountInput').value = 0
                this.shadowRoot.getElementById('vrscRecipient').value = ''
                this.errorMessage = ''
                this.vrscRecipient = ''
                this.vrscAmount = 0
                this.successMessage = this.renderSuccessText()
    ...
    renderSendButton() {
        if ( this._selectedWallet === "qort" ) {
            ...
            return html`<vaadin-button theme="primary large" style="width: 75%;" @click=${() => this.openSendPpc()}><vaadin-icon icon="vaadin:coin-piles" slot="prefix"></vaadin-icon> ${translate("walletpage.wchange17")} PPC</vaadin-button>`
            ...
            return html`<vaadin-button theme="primary large" style="width: 75%;" @click=${() => this.openSendDash()}><vaadin-icon icon="vaadin:coin-piles" slot="prefix"></vaadin-icon> ${translate("walletpage.wchange17")} DASH</vaadin-button>`
        } else if ( this._selectedWallet === "xvg" ) {
        ...
        } else if ( this._selectedWallet === "lbc" ) {
            return html`<vaadin-button theme="primary large" style="width: 75%;" @click=${() => this.openSendLbc()}><vaadin-icon icon="vaadin:coin-piles" slot="prefix"></vaadin-icon> ${translate("walletpage.wchange17")} LBC</vaadin-button>`
            ...
            return html`<vaadin-button theme="primary large" style="width: 75%;" @click=${() => this.openSendBch()}><vaadin-icon icon="vaadin:coin-piles" slot="prefix"></vaadin-icon> ${translate("walletpage.wchange17")} BCH</vaadin-button>`
        ...
        } else if ( this._selectedWallet === "vrsc" ) {
            return html`<vaadin-button theme="primary large" style="width: 75%;" @click=${() => this.openSendVrsc()}><vaadin-icon icon="vaadin:coin-piles" slot="prefix"></vaadin-icon> ${translate("walletpage.wchange17")} VRSC</vaadin-button>`
        } else {
            return html``
        }
    }
    ...
    openSendPpc() {
        this.shadowRoot.querySelector("#sendPpcDialog").show();
    }
    ...
    openSendXvg() {
        this.shadowRoot.querySelector("#sendXvgDialog").show();
    }

    openSendLbc() {
        this.shadowRoot.querySelector("#sendLbcDialog").show();
    }
    ...
    openSendZec() {
        this.shadowRoot.querySelector("#sendZecDialog").show();
    }

    openSendBch() {
        this.shadowRoot.querySelector("#sendBchDialog").show();
    }
    ...
    openSendVrsc() {
        this.shadowRoot.querySelector("#sendVrscDialog").show();
    }
    ...
    async getTransactionGrid(coin) {
        ...
        if (coin === 'qort') {
            ...
            this.transactionsGrid.addEventListener(
                'click',
                (e) => {
                    let ppcItem = this.transactionsGrid.getEventContext(e).item
                    this.showPpcTransactionDetails(ppcItem, this.wallets.get(this._selectedWallet).transactions)
                },
                { passive: true }
            )
        } else if (coin === 'doge') {
            ...
            this.transactionsGrid.addEventListener(
                'click',
                (e) => {
                    let xvgItem = this.transactionsGrid.getEventContext(e).item
                    this.showXvgTransactionDetails(xvgItem, this.wallets.get(this._selectedWallet).transactions)
                },
                { passive: true }
            )
        } else if (coin === 'lbc') {
            this.transactionsGrid.addEventListener(
                'click',
                (e) => {
                    let lbcItem = this.transactionsGrid.getEventContext(e).item
                    this.showLbcTransactionDetails(lbcItem, this.wallets.get(this._selectedWallet).transactions)
                },
                { passive: true }
            )
        } else if (coin === 'kmd') {
            this.transactionsGrid.addEventListener(
                'click',
                (e) => {
                    let kmdItem = this.transactionsGrid.getEventContext(e).item
                    this.showKmdTransactionDetails(kmdItem, this.wallets.get(this._selectedWallet).transactions)
                },
                { passive: true }
            )
        } else if (coin === 'firo') {
            ...
            this.transactionsGrid.addEventListener(
                'click',
                (e) => {
                    let zecItem = this.transactionsGrid.getEventContext(e).item
                    this.showZecTransactionDetails(zecItem, this.wallets.get(this._selectedWallet).transactions)
                },
                { passive: true }
            )
        } else if (coin === 'bch') {
            this.transactionsGrid.addEventListener(
                'click',
                (e) => {
                    let bchItem = this.transactionsGrid.getEventContext(e).item
                    this.showBchTransactionDetails(bchItem, this.wallets.get(this._selectedWallet).transactions)
                },
                { passive: true }
            )
        } else if (coin === 'rvn') {
            ...
            this.transactionsGrid.addEventListener(
                'click',
                (e) => {
                    let vrscItem = this.transactionsGrid.getEventContext(e).item
                    this.showVrscTransactionDetails(vrscItem, this.wallets.get(this._selectedWallet).transactions)
                },
                { passive: true }
            )
        }
    ...
    async renderTransactions() {
        if (this._selectedWallet === 'qort') {
            ...
            render(this.renderPpcTransactions(this.wallets.get(this._selectedWallet).transactions, this._selectedWallet), this.transactionsDOM)
        } else if (this._selectedWallet === 'doge') {
            ...
            render(this.renderLbcTransactions(this.wallets.get(this._selectedWallet).transactions, this._selectedWallet), this.transactionsDOM)
        } else if (this._selectedWallet === 'kmd') {
            ...
            render(this.renderBchTransactions(this.wallets.get(this._selectedWallet).transactions, this._selectedWallet), this.transactionsDOM)
        } else if (this._selectedWallet === 'rvn') {
            ...
            render(this.renderVrscTransactions(this.wallets.get(this._selectedWallet).transactions, this._selectedWallet), this.transactionsDOM)
        }
    }
    ...
    renderPpcTransactions(transactions, coin) {
        return html`
            <div style="padding-left:12px;" ?hidden="${!this.isEmptyArray(transactions)}"><span style="color: var(--black);">${translate("walletpage.wchange38")}</span></div>
            <vaadin-grid theme="large" id="${coin}TransactionsGrid" ?hidden="${this.isEmptyArray(this.wallets.get(this._selectedWallet).transactions)}" page-size="25" all-rows-visible>
                <vaadin-grid-column
    ...
    renderXvgTransactions(transactions, coin) {
        return html`
            <div style="padding-left:12px;" ?hidden="${!this.isEmptyArray(transactions)}"><span style="color: var(--black);">${translate("walletpage.wchange38")}</span></div>
            <vaadin-grid theme="large" id="${coin}TransactionsGrid" ?hidden="${this.isEmptyArray(this.wallets.get(this._selectedWallet).transactions)}" page-size="25" all-rows-visible>
                <vaadin-grid-column
    ...
    renderLbcTransactions(transactions, coin) {
        return html`
            <div style="padding-left:12px;" ?hidden="${!this.isEmptyArray(transactions)}"><span style="color: var(--black);">${translate("walletpage.wchange38")}</span></div>
            <vaadin-grid theme="large" id="${coin}TransactionsGrid" ?hidden="${this.isEmptyArray(this.wallets.get(this._selectedWallet).transactions)}" page-size="25" all-rows-visible>
                <vaadin-grid-column
    ...
    renderKmdTransactions(transactions, coin) {
        return html`
            <div style="padding-left:12px;" ?hidden="${!this.isEmptyArray(transactions)}"><span style="color: var(--black);">${translate("walletpage.wchange38")}</span></div>
            <vaadin-grid theme="large" id="${coin}TransactionsGrid" ?hidden="${this.isEmptyArray(this.wallets.get(this._selectedWallet).transactions)}" page-size="25" all-rows-visible>
                <vaadin-grid-column
    ...
    renderBchTransactions(transactions, coin) {
        return html`
            <div style="padding-left:12px;" ?hidden="${!this.isEmptyArray(transactions)}"><span style="color: var(--black);">${translate("walletpage.wchange38")}</span></div>
            <vaadin-grid theme="large" id="${coin}TransactionsGrid" ?hidden="${this.isEmptyArray(this.wallets.get(this._selectedWallet).transactions)}" page-size="25" all-rows-visible>
                <vaadin-grid-column
    ...
    renderVrscTransactions(transactions, coin) {
        return html`
            <div style="padding-left:12px;" ?hidden="${!this.isEmptyArray(transactions)}"><span style="color: var(--black);">${translate("walletpage.wchange38")}</span></div>
            <vaadin-grid theme="large" id="${coin}TransactionsGrid" ?hidden="${this.isEmptyArray(this.wallets.get(this._selectedWallet).transactions)}" page-size="25" all-rows-visible>
                <vaadin-grid-column
    ...
    showPpcTransactionDetails(myTransaction, allTransactions) {
        allTransactions.forEach((transaction) => {
            if (myTransaction.txHash === transaction.txHash) {
                let ppcTxnFlow = myTransaction.inputs[0].address === this.wallets.get(this._selectedWallet).wallet.address ? 'OUT' : 'IN'
                let ppcSender = myTransaction.inputs[0].address
                let ppcReceiver = myTransaction.outputs[0].address
                this.selectedTransaction = { ...transaction, ppcTxnFlow, ppcSender, ppcReceiver }
                if (this.selectedTransaction.txHash.length != 0) {
                    this.shadowRoot.querySelector('#showPpcTransactionDetailsDialog').show()
                }
            }
        })
    }
    ...
    showXvgTransactionDetails(myTransaction, allTransactions) {
        allTransactions.forEach((transaction) => {
            if (myTransaction.txHash === transaction.txHash) {
                let xvgTxnFlow = myTransaction.inputs[0].address === this.wallets.get(this._selectedWallet).wallet.address ? 'OUT' : 'IN'
                let xvgSender = myTransaction.inputs[0].address
                let xvgReceiver = myTransaction.outputs[0].address
                this.selectedTransaction = { ...transaction, xvgTxnFlow, xvgSender, xvgReceiver }
                if (this.selectedTransaction.txHash.length != 0) {
                    this.shadowRoot.querySelector('#showXvgTransactionDetailsDialog').show()
                }
            }
        })
    }

    showLbcTransactionDetails(myTransaction, allTransactions) {
        allTransactions.forEach((transaction) => {
            if (myTransaction.txHash === transaction.txHash) {
                let lbcTxnFlow = myTransaction.inputs[0].address === this.wallets.get(this._selectedWallet).wallet.address ? 'OUT' : 'IN'
                let lbcSender = myTransaction.inputs[0].address
                let lbcReceiver = myTransaction.outputs[0].address
                this.selectedTransaction = { ...transaction, lbcTxnFlow, lbcSender, lbcReceiver }
                if (this.selectedTransaction.txHash.length != 0) {
                    this.shadowRoot.querySelector('#showLbcTransactionDetailsDialog').show()
                }
            }
        })
    }

    showKmdTransactionDetails(myTransaction, allTransactions) {
        allTransactions.forEach((transaction) => {
            if (myTransaction.txHash === transaction.txHash) {
                let kmdTxnFlow = myTransaction.inputs[0].address === this.wallets.get(this._selectedWallet).wallet.address ? 'OUT' : 'IN'
                let kmdSender = myTransaction.inputs[0].address
                let kmdReceiver = myTransaction.outputs[0].address
    ...
    showZecTransactionDetails(myTransaction, allTransactions) {
        allTransactions.forEach((transaction) => {
            if (myTransaction.txHash === transaction.txHash) {
                let zecTxnFlow = myTransaction.inputs[0].address === this.wallets.get(this._selectedWallet).wallet.address ? 'OUT' : 'IN'
                let zecSender = myTransaction.inputs[0].address
                let zecReceiver = myTransaction.outputs[0].address
                this.selectedTransaction = { ...transaction, zecTxnFlow, zecSender, zecReceiver }
                if (this.selectedTransaction.txHash.length != 0) {
                    this.shadowRoot.querySelector('#showZecTransactionDetailsDialog').show()
                }
            }
        })
    }

    showBchTransactionDetails(myTransaction, allTransactions) {
        allTransactions.forEach((transaction) => {
            if (myTransaction.txHash === transaction.txHash) {
                let bchTxnFlow = myTransaction.inputs[0].address === this.wallets.get(this._selectedWallet).wallet.address ? 'OUT' : 'IN'
                let bchSender = myTransaction.inputs[0].address
                let bchReceiver = myTransaction.outputs[0].address
                this.selectedTransaction = { ...transaction, bchTxnFlow, bchSender, bchReceiver }
                if (this.selectedTransaction.txHash.length != 0) {
                    this.shadowRoot.querySelector('#showBchTransactionDetailsDialog').show()
                }
            }
        })
    }
    ...
    showVrscTransactionDetails(myTransaction, allTransactions) {
        allTransactions.forEach((transaction) => {
            if (myTransaction.txHash === transaction.txHash) {
                let vrscTxnFlow = myTransaction.inputs[0].address === this.wallets.get(this._selectedWallet).wallet.address ? 'OUT' : 'IN'
                let vrscSender = myTransaction.inputs[0].address
                let vrscReceiver = myTransaction.outputs[0].address
                this.selectedTransaction = { ...transaction, vrscTxnFlow, vrscSender, vrscReceiver }
                if (this.selectedTransaction.txHash.length != 0) {
                    this.shadowRoot.querySelector('#showVrscTransactionDetailsDialog').show()
                }
            }
        })
    }
