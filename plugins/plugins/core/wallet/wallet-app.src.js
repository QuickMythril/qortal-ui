    ...
    render() {
        return html`
            <div class="wrapper">
                ...
                <mwc-dialog id="nmcUnusedAddressDialog" scrimClickAction="" escapeKeyAction="">
                    <div class="unused-address-dialog">
                        <div style="text-align: center;">
                            <img src="/img/nmc.png" width="32" height="32">
                            <h2>NMC</h2>
                ...
                <mwc-dialog id="dashUnusedAddressDialog" scrimClickAction="" escapeKeyAction="">
                    <div class="unused-address-dialog">
                        <div style="text-align: center;">
                            <img src="/img/dash.png" width="32" height="32">
                            <h2>DASH</h2>
                ...
                <mwc-dialog id="firoUnusedAddressDialog" scrimClickAction="" escapeKeyAction="">
                    <div class="unused-address-dialog">
                        <div style="text-align: center;">
                            <img src="/img/firo.png" width="32" height="32">
                            <h2>FIRO</h2>
    ...
    openUnusedAddressDialog(coin) {
        switch (coin) {
            ...
            case 'rvn':
                ...
                break
            case 'nmc':
                this.shadowRoot.querySelector("#nmcUnusedAddressDialog").show();
                break
            case 'dash':
                this.shadowRoot.querySelector("#dashUnusedAddressDialog").show();
                break
            case 'firo':
                this.shadowRoot.querySelector("#firoUnusedAddressDialog").show();
                break
            default:
                break
        }
